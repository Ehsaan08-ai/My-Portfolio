  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* End spacer so last card doesn't slam right edge */}
...
/**
 * ProjectCard — Individual project card with magnetic tilt effect,
 * animated gradient border, parallax image, and micro-interactions.
 */
